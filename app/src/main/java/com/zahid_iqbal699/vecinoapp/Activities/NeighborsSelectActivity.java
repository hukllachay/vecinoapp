...
public class NeighborsSelectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            firebaseDatabaseHelper = new FirebaseDatabaseHelper(NeighborsSelectActivity.this);
                ...
                public void onClick(View v) {
                    ...
                    if (actorList.size() < 1) {
                        ...
                        if (type.equals("single")) {
                            ...
                            for (int i = 0; i < actorList.size(); i++) {
                                ...
                                query.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        ...
                                        if (!snapshot.exists()) {
                                            tableInitiatives.child(initiativesModel.getiId()).child("Neighbors").child(neighborsModel.getnId()).setValue(neighborsModel).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                            ...
                            tableInitiatives.child(initiativesModel.getiId()).setValue(initiativesModel).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        for (int i = 0; i < actorList.size(); i++) {
