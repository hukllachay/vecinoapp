package com.grupo1.vecinoapp.Adapters;
...
import com.grupo1.vecinoapp.Activities.InitiativeDetailsActivity;
        ...
        tableInitiatives.child(projectModel.getiId()).child("Neighbors").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (complete > 0) {
                    ...
                    holder.tvPercent.setText(String.valueOf(percentage * 100));
